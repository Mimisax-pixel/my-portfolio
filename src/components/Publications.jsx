    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center h-full">
        <div className="mt-40 sm:mt-20">
          <p className="tracking-wide font-bold inline border-b-4 dark:border-red-800 border-teal-500 text-3xl md:text-4xl mt-10">
            Publications
          </p>
        </div>
        <p className="mt-5 rounded-lg shadow-md text-md">
          ...
          <a
            ...
            className="underline text-xl sm:text-2xl hover:text-gray-400 text-gray-900 dark:text-white hover:font-bold"
          >
          ...
          <h3 className="text-sm sm:text-md">
            Onukak, Wisdom Okon, Ogunleye, Iyanuoluwa Abiola and Butum, Grace Allan
          </h3>
          <br />
        </p>

        <div>
          <h3 className="tracking-wide font-bold inline border-b-4 dark:border-red-800 border-teal-500 text-3xl md:text-4xl mt-10">
            News Stories and Articles Published
          </h3>
          <br />
          <ul className="mt-5">
            <li className="md:mt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-900 dark:text-white underline text-lg sm:text-xl hover:text-gray-400 hover:font-bold"
              >
